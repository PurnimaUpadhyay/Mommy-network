                ...
                <div class="brands-banner wow fadeIn" data-wow-duration="1s" data-wow-delay="0.50s">
                    ...
                    <div class="breadcumb-example wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Educational Products &amp; Services</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="grid-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
                        <div class="grid-style clearfix">
                            <h4>Educational Products &amp; Services</h4>
                            <div class="col-md-4">
                                <img src="img/logos/Bake-me.png" class="img-responsive" alt="Bake-me" width="240px"></div>
                            <div class="col-md-4">
                                <img src="img/logos/Bookyboo.png" class="img-responsive" alt="Bookyboo">
                            </div>
                            <div class="col-md-4">
                                <img src="img/logos/Kinderhome.png" class="img-responsive" alt="Kinderhome">
                            </div>
                            <div class="col-md-4">
                                <img src="img/logos/Skillmatics.png" class="img-responsive" alt="Skillmatics">
                            </div> 
                            <div class="col-md-4">
                             <img src="img/logos/Brainsmith.png" class="img-responsive" alt="Brainsmith">
                            </div>
                            <div class="col-md-4">
                              <img src="img/logos/PodSquad.png" class="img-responsive" alt="PodSquad">
                            </div>
                            <div class="col-md-4">
                                <img src="img/logos/ETL.png" class="img-responsive" alt="ETL" width="200px"></div>
                        </div>
                        </div>
                    </div>
                </div>
