                ...
                <div class="col-md-12">
                    ...
                    <div class="grid-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
                        <div class="grid-style clearfix">
                            <h4>Play</h4>
                            <div class="col-md-4">
                                 <img src="img/logos/shumee-logo.png" class="img-responsive" alt="shumee"></div>
                            <div class="col-md-4">
                                  <img src="img/logos/Junior j.png" class="img-responsive" alt="Junior j">
                            </div>
                            <div class="col-md-4">
                                  <img src="img/logos/Kids-pallete.png" class="img-responsive" alt="Kids-pallete">
                            </div>
