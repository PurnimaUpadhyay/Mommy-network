                ...
                <div class="grid">
                    <div class="grid-item">
                        <div class="grid-style">
                            <h4>Personalized Gifting</h4>
                            <div>
                                 <img src="img/logos/paper-windmill.png" class="img-responsive" alt="paper-windmill">
                                  <img src="img/logos/all-that-jazz.png" class="img-responsive" alt="all-that-jazz">
                                  <img src="img/logos/dottedi.png" class="img-responsive" alt="dottedi">
                                  <img src="img/logos/Pigtales.png" class="img-responsive" alt="Pigtales">
                                  <img src="img/logos/ItsAWrap.png" class="img-responsive" alt="ItsAWrap">
                            </div>
                        </div>
                    </div>
                    <div class="grid-item">
                        <div class="grid-style">
                            <h4>Others</h4>
                            <div>
                                <img src="img/logos/helping-hands.png" class="img-responsive" alt="helping-hands">
                                <img src="img/logos/MMB.png" class="img-responsive" alt="MMB">
                                <img src="img/logos/avanchy-logo.png" class="img-responsive" alt="avanchy">
                            </div>
                        </div>
                    </div>
