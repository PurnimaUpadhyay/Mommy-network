...
<body class="masonarydiv">
    <main class="cf">
        ...
        <div class="container-fluid main-container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="singelelogo-box">
                    <div class="grid-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
                        <div class="grid-style clearfix">
                            <h4>Food</h4>
                            <div class="col-md-4">
                                 <img src="img/logos/mummco.png" class="img-responsive" alt="mummco"></div>
                            <div class="col-md-4">
                                  <img src="img/logos/Sustenance-Logo.png" class="img-responsive" alt="Sustenance">
                            </div>
                            <div class="col-md-4">
                                   <img src="img/logos/Zanys.png" class="img-responsive" alt="Zany's">
                            </div>
                            <div class="col-md-4">
                                   <img src="img/logos/butternut-co.png" class="img-responsive" alt="butternut-co">
                            </div>
                            <div class="col-md-4">   
                                <img src="img/logos/Gouris.png" class="img-responsive" alt="Gouris">
                            </div>
                            <div class="col-md-4 clearfix">   
                                <img src="img/logos/nomba Logo with Registered Symbol-Black.png" class="img-responsive" alt="Nomba">
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-md-4 clearfix">   
                                <img src="img/logos/papa-bubble.png" class="img-responsive" alt="papabubble">
                            </div>
                            <div class="col-md-4 clearfix">   
                                <img src="img/logos/chado.png" class="img-responsive" alt="chado">
                            </div>

                             <div class="col-md-4 clearfix">   
                                <img src="img/logos/All heart logo_small.png" class="img-responsive" alt="All heart">
                            </div>
                            <div class="clearfix">
                            </div>
                            
                            <div class="col-md-4 clearfix">   
                                <img src="img/logos/EDD2-05.png" class="img-responsive" alt="EDD">
                            </div>


                            <div class="col-md-4 clearfix">   
                                <img src="img/logos/mos-kefir-logo-tranparent.png" class="img-responsive" alt="mos-kefir-logo-tranparent">
                            </div>

                             <div class="col-md-4 clearfix">
                                  <img src="img/logos/Slurrp-Farm.png" class="img-responsive" alt="Slurrp-Farm">
                            </div>
                        </div>
                        </div>
                    </div>
