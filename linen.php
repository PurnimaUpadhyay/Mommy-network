                ...
                <div class="col-md-12">
                    ...
                    <div class="grid-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
                        <div class="grid-style clearfix">
                            <h4>Linen</h4>
                            <div class="col-md-4">
                                <img src="img/logos/Masilo-logo.png" class="img-responsive" alt="Masilo"></div>
                            <div class="col-md-4">
                              <img src="img/logos/sommer-home.png" class="img-responsive" alt="sommer-home">
                            </div>
                            <div class="col-md-4">
                              <img src="img/logos/The-Boho-bungalow-sticker-and-ribbon-1.png" class="img-responsive" alt="The-Boho-bungalow-sticker">
                            </div>
                            <div class="col-md-4">
                                <img src="img/logos/malabar-baby.png" class="img-responsive" alt="Malabar-baby"></div>
                        </div>
                        </div>
                    </div>
                </div>
