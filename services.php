                ...
                <div class="col-md-12">
                    ...
                    <div class="grid-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="2s">
                        <div class="grid-style clearfix">
                            <h4>Services</h4>
                            <div class="col-md-4">
                              <img src="img/logos/first-impression.png" class="img-responsive" alt="first-impression"></div>
                            <div class="col-md-4">
                              <img src="img/logos/shruti-tejwani.png" class="img-responsive" alt="shruti-tejwani">
                            </div>
