                ...
                <div class="grid">
                    <div class="grid-item">
                        <div class="grid-style">
                            <h4>Baby Carriers &amp; Swaddles</h4>
                            <div>
                                 <img src="img/logos/anmol.png" class="img-responsive" alt="Anmol">
                                 <img src="img/logos/woombie.png" class="img-responsive" alt="woombie">
                                 <img src="img/logos/BabyLove.png" class="img-responsive" alt="BabyLove">
                    ...
                    <div class="grid-item">
                        <div class="grid-style">
                            <h4>Jewelry</h4>
                            <div>
                                <img src="img/logos/doodle-by-poorvi.png" class="img-responsive" alt="doodle-by-poorvi">
                                <img src="img/logos/Gempetit.png" class="img-responsive" alt="Gempetit">
                                <img src="img/logos/Ma-BOND.png" class="img-responsive" alt="Ma-BOND">
                       ...
                       <div class="grid-item">
                        <div class="grid-style">
                            <h4>Shoes</h4>
                            <div>
                                <img src="img/logos/Careeno.png" class="img-responsive" alt="Careeno">
                                <img src="img/logos/tao-paris.png" class="img-responsive" alt="tao-paris">
                                <img src="img/logos/fizzy-goblet.png" class="img-responsive" alt="fizzy-goblet">
                                <img src="img/logos/Rushali.png" class="img-responsive" alt="Rushali">
                            </div>
                        </div>
                    </div>
                </div>
