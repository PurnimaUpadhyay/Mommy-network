                ...
                <div class="brands-banner wow fadeIn" data-wow-duration="1s" data-wow-delay="0.50s">
                    ...
                    <div class="breadcumb-example wow slideInLeft" data-wow-duration="1s" data-wow-delay="1s">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Décor &amp; Furniture</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="grid">
                    <div class="grid-item">
                        <div class="grid-style">
                            <h4>Furniture</h4>
                            <div>
                                <img src="img/logos/big-bear-hug.png" class="img-responsive" alt="big-bear-hug">
                                <img src="img/logos/thoe-&-pomo.png" class="img-responsive" alt="thoe-&-pomo">
                                <img src="img/logos/Baby-select.png" class="img-responsive" alt="Baby-select">
                            </div>
                        </div>
                    </div>
                    <div class="grid-item">
                        <div class="grid-style">
                            ...
                            <div>
                               ...
                               <img src="img/logos/kiddy-cuddle-co.png" class="img-responsive" alt="kiddy-cuddle-co">
                               <img src="img/logos/Baby-palette.png" class="img-responsive" alt="Baby-palette">
                               <img src="img/logos/elan-logo.png" class="img-responsive" alt="Elan">
